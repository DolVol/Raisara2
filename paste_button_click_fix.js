// ✅ PASTE BUTTON CLICK FIX
// This ensures the paste button shows the paste options dialog when clicked
...
(function() {
    ...
    function ensurePasteButtonHandler() {
        ...
        if (pasteBtn) {
            ...
            // Also set it as a property for compatibility
    ...
    setTimeout(ensurePasteButtonHandler, 2000); // Double check
