...
# Script to add clipboard routes to app.py
...
# Find the position to insert the clipboard routes (before if __name__ == '__main__':)
insert_position = content.find("if __name__ == '__main__':")

if insert_position != -1:
    # Insert the clipboard routes before the main block
    new_content = content[:insert_position] + clipboard_routes + "\n" + content[insert_position:]
    
    # Write the updated content back to the file
    with open('app.py', 'w', encoding='utf-8') as f:
        f.write(new_content)
    
    print("✅ Successfully added clipboard routes to app.py")
else:
